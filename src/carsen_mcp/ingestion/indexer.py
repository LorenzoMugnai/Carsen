...
def index_config(config: CarsenConfig, force: bool = False, embed: bool = False, embedding_provider: EmbeddingProvider | None = None, vector_store: QdrantVectorStore | None = None) -> IndexReport:
...
def index_vectors_for_config(config: CarsenConfig, embedding_provider: EmbeddingProvider | None = None, vector_store: QdrantVectorStore | None = None, recreate: bool = False) -> int:
